DROP TABLE IF EXISTS `emall_product_category`;
...
DROP TABLE IF EXISTS `emall_brand`;
...
DROP TABLE IF EXISTS `emall_product_sku`;
...
DROP TABLE IF EXISTS `emall_category_attribute_relation`;
...
DROP TABLE IF EXISTS `emall_product_attribute`;
...
DROP TABLE IF EXISTS `emall_product_attribute_value`;
