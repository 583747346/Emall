...
//        gc.setSwagger2(true); //实体属性 Swagger2 注解
        ...
        dsc.setUrl("jdbc:mysql://139.196.160.33:3306/emall_manageplat?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        // 如果模板引擎是 velocity
        // String templatePath = "/templates/sys.xml.vm";
        ...
        cfg.setFileCreate(new IFileCreate() {
            ...
            public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
                ...
                if (fileType == FileType.MAPPER) {
                    // 已经生成 sys 文件判断存在，不想重新生成返回 false
